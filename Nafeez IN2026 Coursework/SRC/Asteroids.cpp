...
void Asteroids::Start()
{
	...
	//Animation* spaceship_anim = AnimationManager::GetInstance().CreateAnimationFromFile("guide", 1888, 1888, 1125, 1125, "HowToPlay.png");
...
void Asteroids::CreateGUI()
{
	...
	container->AddComponent(static_pointer_cast<GUIComponent>(mBackLabel), GLVector2f(0.001f, 0.99f));
